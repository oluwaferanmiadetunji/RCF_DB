		                ...
		                <div class="col-lg-12">
		                    <div class="p-5">
								...
								<div class="bootstrap-iso">
			                        <form class="user" action="utilities/create.php" method="POST">
			                            <div class="form-group row">
			                                <label for="name" class="col-sm-2 col-form-label form_label">Fullname</label>
			                                <div class="col-sm-8">
			                                    <input type="text" class="form-control form-control-user" required autofocus value="" name="name" id="name">
			                                </div>
			                            </div>
			                            ...
			                            <div class="form-group row">
			                                ...
			                                <div class="col-sm-8">
			                                    <input type="email" class="form-control form-control-user" required value="" name="email" id="email">
			                                </div>
			                            </div>
										<div class="form-group row">
			                                <label for="phone" class="col-sm-2 col-form-label form_label">Phone Number</label>
			                                <div class="col-sm-8">
			                                    <input type="tel" class="form-control form-control-user" required value="" name="phone" id="phone">
			                                </div>
			                            </div>
                                  <div class="form-group row">
                                  ...
                                  <div class="form-group row">
			                                ...
			                                <div class="col-sm-8">
			                                    <input type="text" class="form-control form-control-user" required value="" name="dob" id="dob" placeholder="Enter date of birth in format: Month Date e.g January 1">
			                                </div>
			                            </div>
										<div class="form-group row">
			                                <label for="role" class="col-sm-2 col-form-label form_label">Faculty</label>
			                                <div class="col-sm-8">
                                                <input type="text" class="form-control form-control-user" required value="" name="faculty" id="faculty">
			                                    <!-- <select class="custom-select my-1 mr-sm-2" id="faculty" name="faculty">
		                                ...
		                                <div class="form-group row">
			                                ...
			                                <div class="col-sm-8">
                                                <input type="text" class="form-control form-control-user" required value="" name="dept" id="dept">
		                                ...
		                                <div class="form-group row">
			                                ...
			                                <div class="col-sm-8">
			                                    <select class="custom-select my-1 mr-sm-2" id="level" name="level">
		                                            ...
		                                            <option value="200 levell">200 Level</option>
										...
										<div class="form-group row">
			                                ...
			                                <div class="col-sm-8">
			                                    <input type="text" class="form-control form-control-user" required value="" name="school_address" id="school_address">
			                                </div>
			                            </div>
                                  <div class="form-group row">
			                                <label for="name" class="col-sm-2 col-form-label form_label">Zone</label>
			                                <div class="col-sm-8">
			                                    <input type="text" class="form-control form-control-user" value="" name="zone" id="zone">
			                                </div>
			                            </div>
		                                <div class="form-group row">
			                                <label for="address" class="col-sm-2 col-form-label form_label">Home Address</label>
			                                <div class="col-sm-8">
			                                    <input type="text" class="form-control form-control-user" required value="" name="home_address" id="home_address">
			                                </div>
			                            </div>
		                                <div class="form-group row">
										...
										<div class="form-group row">
			                                ...
			                                <div class="col-sm-8">
			                                    <select class="custom-select my-1 mr-sm-2" id="unit" name="unit">
		                                            ...
		                                            <option value="Alumni relations">Alumni Relations Unit</option>
		                                            <option value="Bible study">Bible Study Unit</option>
